...
\N{Finite Difference in Anticommuting Variables}
...
\begin{multline}\label{eq:differentiation:from-the-left}
...
\N{Convention} We will write the left derivative of $f(x,\theta)$ with
...
\begin{exercise}[Graded product rule]
  \begin{enumerate}
