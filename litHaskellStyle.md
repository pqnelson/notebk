...
These are macros based off of the style from the Haskell wiki, and the macros found from [this blog](http://ulissesaraujo.wordpress.com/2008/03/30/latex-listings-package-haskell/).
...
\usepackage{listings}
%%%
% EITHER use the courier package
% OR uncomment the line below it!
%%%
\usepackage{courier}
...
\definecolor{ST0}{RGB}{221,17,68} % #d14
