...
which is called the \define{order topology}.
\end{defn}
...
four subsets of $X$ that are called the \define{rays} determined
...
\end{align}
\end{subequations}
The first two are \define{open rays}, the last two are
\define{closed rays}.
\end{defn}
