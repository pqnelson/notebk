...
\begin{definition}\index{Lorentz Group}\index{Group!Lorentz}
...
\begin{definition}\index{Poincar\'e Group}\index{Poincar\'e!Group}\index{Lorentz Group!Inhomogeneous}\label{defn:relativity:poincare-group}
