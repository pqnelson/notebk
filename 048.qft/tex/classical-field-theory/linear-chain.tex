...
\N{Assumptions} There are two critical assumptions we make before we
...
\define*{Lagrangian Density}\index{Lagrangian!Density}, and written as $\mathcal{L}$. For us,
\begin{equation}
...
\N{Cautionary Remark: What are Scalar Fields?}\index{Field!As section of bundle}
