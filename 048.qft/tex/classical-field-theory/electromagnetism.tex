...
\N{Lagrangian Density}\index{Maxwell!Lagrangian density}\index{Lagrangian!Maxwell}
...
\step{since $\partial_{\alpha}(\variation A_{\beta}) = \variation(\partial_{\alpha}A_{\beta}$}
-\eta^{\alpha\mu}\eta^{\beta\nu}F_{\mu\nu}\partial_{\alpha}(\variation A_{\beta})
\step{index gymnastics}
-\eta^{\alpha\mu}F_{\mu\nu}\partial_{\alpha}(\variation A^{\nu}).\qedhere
\end{calculation}
\end{proof}
...
\N{Derivation of Electromagnetic Waves}
...
\N{Minimal coupling}\index{Coupling!Minimal}\index{Minimal coupling|see{Coupling, Minimal}}
...
giving us the Proca Lagrangian density:\index{Proca!Lagrangian}\index{Lagrangian!Proca}
\begin{equation}
