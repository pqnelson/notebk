...
Let $a^{\mu}$ be any event. We define the \define{Light cone} for $a^{\mu}$
...
in the past, giving us the \define*{Future Light Cone}\index{Light cone!Future}
\begin{equation}
\mathscr{C}^{+} = \{\,b^{\mu}\in\mathscr{C} \mid b^{0} > a^{0}\,\},
\end{equation}
and the \define*{Past Light Cone}\index{Light cone!Past} consisting of events preceding $a^{\mu}$,
\begin{equation}
\mathscr{C}^{-} = \{\,b^{\mu}\in\mathscr{C} \mid b^{0} < a^{0}\,\}.
\end{equation}
We can take the \define*{Closed Light Cone}\index{Light cone!Closed} to consist of all light-like
